...
def generate_recommendation_core(
    ...
    return {
        ...
        "trend": trend,
        "sentiment": sentiment,
        "social_post_count": int(risk_context.get("social_post_count", 0)),
        "market_news_count": int(risk_context.get("market_news_count", 0)),
        "social_quality": round(signals["social"].confidence, 4),
